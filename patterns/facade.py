...
when as a user or as a class I don't care about the process behind the application
I just to do a click and receive the repsonse I want

example UI is the fecade of the API and the API can be a facade of a backend that is more complex
hide the complexity behind a facade
